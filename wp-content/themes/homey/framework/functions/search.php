...
if( !function_exists('homey_half_map') ) {
    function homey_half_map() {
        ...
        //Change By Parth
        $instant_booking = isset($_POST['instant_booking']) ? $_POST['instant_booking'] : '';
        ...
        while( $query_args->have_posts() ): $query_args->the_post();
            ...
            if(isset($_POST['arrive'])){
                $params.="arrive=".$_POST['arrive'];
            }
            if(isset($_POST['start_hour'])){
                $params.="&start=".$_POST['start_hour'];
            }
            if(isset($_POST['end_hour'])){
                $params.="&end=".$_POST['end_hour'];
            }
            $listing->url = get_permalink() . $params;
