    ...
    function homey_listing_permalink($listing_id = null)
    {
        ...
        if($homey_booking_type == 'per_hour') {
            ...
            if(isset($_REQUEST['arrive']) && isset($_REQUEST['start']) ) {
                $check_in  =   sanitize_text_field($_REQUEST['arrive']);
            ...
            if(isset($_REQUEST['arrive']) && isset($_REQUEST['depart']) ) {
                $check_in  =   sanitize_text_field($_REQUEST['arrive']);
                $check_out   =   sanitize_text_field($_REQUEST['depart']);
                $guest   =   sanitize_text_field($_REQUEST['guest']);
...
if(!function_exists('homey_stripe_payment_for_featured') ) {
    function homey_stripe_payment_for_featured()
    {
        ...
        include_once HOMEY_PLUGIN_PATH . '/includes/stripe-php/init.php';
...
if(!function_exists('homey_create_print')) {
    function homey_create_print()
    {
        ...
        if($booking_type == 'per_hour') {
            $weekends_price = homey_get_listing_data_by_id('hour_weekends_price', $listing_id);
        } else {
                            ...
                            <div class="block-right">
                                <span class="item-price">
                                    <?php if($booking_type == 'per_hour') { ?>
                                        <?php echo homey_formatted_price($hour_price, true, true); ?><sub>/<?php echo homey_option('glc_hour_label');?></sub>
                                    <?php } else { ?>
                                ...
                                <div class="block-right">
                                    <ul class="detail-list detail-list-2-cols">
                                        ...
                                        <?php if($booking_type == 'per_hour') { ?>
                                            ...
                                            <?php if(!empty($hour_price)) { ?>
                                            <li>
                                                <i class="fa fa-angle-right" aria-hidden="true"></i> 
                                                <?php echo homey_option('sn_hourly_label');?>: 
                                                <strong><?php echo homey_formatted_price($hour_price, true); ?></strong>
                                            </li>
                                            <?php } ?>
                            ...
                            <div class="block-body">
                                ...
                                <div class="block-right">
                                    ...
                                    <div class="block-col block-col-33 block-accomodation">
                                        ...
                                        <dl>
                                            <?php 
                                            if($acc['acc_guests'] > 1) { $guests = homey_option('sn_acc_guests_label'); 
                                            } else { $guests = $homey_local['acc_guest_label']; 
                                            }
                                    ...
                                    <ul class="detail-list detail-list-2-cols">
                                        <?php if($booking_type == 'per_hour') { ?>
                                            <li>
                                                ...
                                                <?php echo homey_option('sn_min_stay_is');?> <strong><?php echo esc_attr($min_stay_hours); ?> <?php echo $min_book_hours_label;?></strong>
                                            </li>
                                        <?php } else { ?>
                                            <li>
                                                <i class="fa fa-calendar-o" aria-hidden="true"></i> 
