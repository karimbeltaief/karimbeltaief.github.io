...
$homey_invoice_item_id = get_post_meta(get_the_ID(), 'homey_invoice_item_id', true);
$reservation_status = get_post_meta($homey_invoice_item_id, 'reservation_status', true);
?>
<tr>
    <?php /* ?><td data-label="Order">
        #<?php echo get_the_ID(); ?>
    </td><?php */ ?>

    <td data-label="Order">
        #<?php echo $homey_invoice_item_id; ?>
    </td>
