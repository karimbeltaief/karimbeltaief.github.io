                        ...
                        <div class="block">
                            ...
                            <div class="block-section">
                                <div class="block-body">
                                        ...
                                        <ul class="detail-list detail-list-2-cols">
                                            <li>
                                                ...
                                                <strong>
                                                    ...
                                                    <?php echo date('g:i a',strtotime($check_in)); ?>
                                                </strong>
                                            </li>
                                            <li>
                                                ...
                                                <strong>
                                                    <?php echo homey_format_date_simple($check_in_date); ?>
                                                    <?php echo esc_html__('at', 'homey'); ?>
                                                    <?php echo date('g:i a',strtotime($check_out)); ?>
                                                </strong>
                                            </li>
                                            <li>
                                    ...
                                    <div style="padding: 0;float: left;">
                                        <strong><?php echo __('Notes :','homey'); ?><?php echo __('Les annulations sont possibles 48H avant le début de la réservation.','homey'); ?></strong>
                                    </div>
                                </div><!-- block-body -->
                            </div><!-- block-section -->    
                            ...
                            <div class="block-section">
                                <div class="block-body">
                                    ...
                                    <div class="block-right">
                                        <?php echo homey_child_calculate_hourly_reservation_cost($reservationID); ?>
                                    </div><!-- block-right -->
                                </div><!-- block-body -->
                            </div><!-- block-section -->
                        </div><!-- .block -->
