...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Event    </div>

    <div class="panel-body">
                
        <form action="{{ url('/events'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-2">
                    <input type="number" name="calendar_id" id="calendar_id" class="form-control" value="{{$model['calendar_id'] or ''}}"readonly>
                </div>
            </div>
                                                                                    <div class="form-group">
                <label for="google_id" class="col-sm-3 control-label">Google Id</label>
                <div class="col-sm-6">
                    <input type="text" name="google_id" id="google_id" class="form-control" value="{{$model['google_id'] or ''}}"readonly>
                </div>
            </div>
                                                                                                <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="number" name="allday" id="allday" class="form-control" value="{{$model['allday'] or ''}}">
                </div>
            </div>
                                                                                                            <div class="form-group">
                <label for="started_at" class="col-sm-3 control-label">Started At</label>
                <div class="col-sm-3">
                    <input type="date" name="started_at" id="started_at" class="form-control" value="{{$model['started_at'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                <label for="ended_at" class="col-sm-3 control-label">Ended At</label>
                <div class="col-sm-3">
                    <input type="date" name="ended_at" id="ended_at" class="form-control" value="{{$model['ended_at'] or ''}}">
                </div>
            </div>
                                                                                                            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="hobby_mood_event" id="hobby_mood_event" class="form-control" value="{{$model['hobby_mood_event'] or ''}}">
                </div>
            </div>
