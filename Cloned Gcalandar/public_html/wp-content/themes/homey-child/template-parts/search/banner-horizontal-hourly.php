                    ...
                    case 'location':
                        ...
                        <div class="<?php echo esc_attr($location_classes); ?>">
                            ...
                            <?php } elseif($location_field == 'country') { ?>
                                ...
                                <?php
                                // All Option
                                echo '<option value="">1.'.esc_attr(homey_option('srh_whr_to_go')).'</option>';
                            ...
                            <?php
                            // All Option
                            echo '<option value="">2.'.esc_attr(homey_option('srh_whr_to_go')).'</option>';
                            ...
                            <?php
                            // All Option
                            echo '<option value="">3.'.esc_attr(homey_option('srh_whr_to_go')).'</option>';
                            ...
                            <?php
                            // All Option
                            echo '<option value="">4.'.esc_attr(homey_option('srh_whr_to_go')).'</option>';
