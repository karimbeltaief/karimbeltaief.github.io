...
$cancellation_policy_in_48H = homey_get_field_meta('cancellation_policy_in_48H'); 
...
<div id="rules-tab" class="tab-pane fade <?php echo esc_attr($class); ?>">
    ...
    <div class="block-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="start_hour" class="selectpicker" <?php homey_required('start_hour'); ?> id="start_hour" data-live-search="false" title="<?php echo esc_attr(homey_option('ad_text_select')); ?>">
                                ...
                                for ($halfhour = $start_hour;$halfhour <= $end_hour; $halfhour = $halfhour+60*60) {
                                    echo '<option '.selected(date('H:i',$halfhour), $get_start_hour, false).' value="'.date('H:i',$halfhour).'">'.date('H:i',$halfhour).'</option>';
                                }
                                ?>
                        </select>
                    </div>
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="end_hour" class="selectpicker" <?php homey_required('end_hour'); ?> id="end_hour" data-live-search="false" title="<?php echo esc_attr(homey_option('ad_text_select')); ?>">
                            ...
                            <?php 
                            for ($halfhour = $start_hour;$halfhour <= $end_hour; $halfhour = $halfhour+60*60) {
                                echo '<option '.selected(date('H:i',$halfhour), $get_end_hour, false).' value="'.date('H:i',$halfhour).'">'.date('H:i',$halfhour).'</option>';
                            }
                            ?>
                        </select>
                    </div>
        ...
        <div class="row">
            <!--Cancel policy in 48 hours-->
            <div class="col-sm-6 col-xs-12">
                <label class="label-condition"><?php echo __('Annulation possible Avant 48H','homey'); ?>?</label>
            </div>
            <div class="col-sm-6 col-xs-12">
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label class="control control--radio radio-tab">
                                <input <?php checked($cancellation_policy_in_48H, '1'); ?> name="cancellation_policy_in_48H" value="1" type="radio" checked >
                    ...
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label class="control control--radio radio-tab">
                                <input <?php checked($cancellation_policy_in_48H, '0'); ?> name="cancellation_policy_in_48H" value="0" type="radio">
