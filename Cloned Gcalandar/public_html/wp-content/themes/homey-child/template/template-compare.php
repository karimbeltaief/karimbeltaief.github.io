...
$basic_info_escaped = $list_night_price = $listing_title = $list_bedrooms = $list_guests = $list_beds = $list_baths = $list_type = $list_size = $booking = '';
$counter   =  0;
$listings  =  array();
$hide_labels = homey_option('show_hide_labels');
//echo "<pre>"; print_r($hide_labels);
?>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                if( $the_query->have_posts() ): while( $the_query->have_posts() ): $the_query->the_post();
                    ...
                    $instant_booking    = get_post_meta( get_the_ID(), $homey_prefix.'instant_booking', true );
                    ...
                    if( $instant_booking > 0 ) {
                        $booking .= '<td><i class="fa fa-check text-success"></i></td>';
                    } else {
                        $booking .= '<td><i class="fa fa-times text-danger"></i></td>';
                    }
                ...
                <div class="compare-table">
                    <table class="table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong><?php echo homey_option('sn_guests_label'); ?></strong></td>
                            ...
                            <tr>
                                <td><strong><?php echo __('réservation instantanée','homey'); ?></strong></td>
                                <?php echo $booking; ?>
                                
                            </tr>
                            
                            <tr>
                                <td colspan="3" style="text-align: center; font-size: 16px; font-weight: bold;"><?php echo __('Les aménagements','homey') ?></td>
                            </tr>
                            
                            <?php
                            $all_facility = get_terms( array( 'taxonomy' => 'listing_facility', 'fields' => 'names' ) );
                            $compare_terms = array();

                            foreach ( $ids as $post_ID ) :

                            $compare_terms[ $post_ID ] = wp_get_post_terms( $post_ID, 'listing_facility', array( 'fields' => 'names' ) );

                            endforeach;

                            foreach ( $all_facility as $data ) : 
                            ...
                            ?>
                            <tr>
                                <td colspan="3" style="text-align: center; font-size: 16px; font-weight: bold;"><?php echo __('Équipements','homey') ?></td>
                            </tr>
                            <?php
