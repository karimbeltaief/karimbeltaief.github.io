...
if( !function_exists('homey_get_localization')) {
	function homey_get_localization() {
		...
		$localization = array(
			...
			'night_label' => esc_html__('nuit', 'homey'),
			'nights_label' => esc_html__('nuits', 'homey'),
			'hour_label' => esc_html__('heure', 'homey'),
			'hours_label' => esc_html__('heures', 'homey'),
			...
			'cal_label' => esc_html__('Calendrier', 'homey'),
			...
			'dates_not_available' => esc_html__('Vos dates ne sont pas disponibles', 'homey'),
			'hours_not_available' => esc_html__('Cette salle n’est pas disponible à cette heure.', 'homey'),
			'hours_already_booked' => esc_html__('La salle est déjà réservé par quelqu’un sur cette période', 'homey'),
			'dates_available' => esc_html__('Vos dates sont disponibles!', 'homey'),
			'hours_available' => esc_html__('Cette salle est disponible à cette heure.', 'homey'),
			'request_sent' => esc_html__('Demande de réservation envoyée. S’il vous plaît attendre la confirmation!', 'homey'),
			'reserve_period_success' => esc_html__('Vous avez réservé avec succès une période', 'homey'),
			'fill_all_fields' => esc_html__('Veuillez remplir tous les champs', 'homey'),
			'choose_checkin' => esc_html__('Veuillez choisir une date d’arrivée', 'homey'),
			'choose_checkout' => esc_html__('Veuillez sélectionner la date de départ', 'homey'),
			'choose_start_hour' => esc_html__('Veuillez sélectionner l’heure de début', 'homey'),
			'choose_end_hour' => esc_html__('Veuillez sélectionner la date de fin', 'homey'),
			'choose_guests' => esc_html__('S’il vous plaît choisir des invités', 'homey'),
			'own_listing_error' => esc_html__('Vous ne pouvez pas réserver votre propre liste.', 'homey'),
			'host_user_cannot_book' => esc_html__('Vous devez vous connecter comme locataire ou abonné pour pouvoir vous inscrire. ', 'homey'),

			'start_date_label' => esc_html__('Veuillez sélectionner la date de début', 'homey'),
			'end_date_label' => esc_html__('Veuillez sélectionner la date de fin', 'homey'),
			...
			'cs_tax_fees' => esc_html__('Toute taxe comprise', 'homey'),
			'cs_view_details' => esc_html__('Voir les détails', 'homey'),
			'cs_add_guest' => esc_html__('Invité supplémentaire', 'homey'),
			'cs_add_guests' => esc_html__('Invités supplémentaires', 'homey'),
			'cs_cleaning_fee' => esc_html__('Frais de nettoyage', 'homey'),
			'cs_city_fee' => esc_html__('Frais municipaux', 'homey'),
			'cs_sec_deposit' => esc_html__('Caution', 'homey'),
			'cs_services_fee' => esc_html__('Frais de services', 'homey'),
			'cs_taxes' => esc_html__('Taxes', 'homey'),
			'cs_payment_due' => esc_html__('Paiement dû', 'homey'),
			'cs_pay_rest_1' => esc_html__('Solde dû', 'homey'),
			...
			'ins_book_proceed' => esc_html__("L'heure de départ doit être supérieure à l'heure d'arrivée", 'homey'),
			'ins_hourly_book_proceed' => esc_html__("L'heure de départ doit être supérieure à l'heure d'arrivée", 'homey'),
			...
			*------------------------------------------------------*/
			...
			'sr_apply_label' => esc_html__('Appliquer', 'homey' ),
			...
			*------------------------------------------------------*/
			...
			'declined_auto' => esc_html__( 'Quelqu’un a payé avant vous, désolé pour ce désagrément.', 'homey' ),

            'unexpected_error' => esc_html__('Oups. Une erreur inattendu est survenue ! Veuillez contacter l’administrateur du site.', 'homey'),
            'date_already_unavailable' => esc_html__("La salle est déjà indisponible entre cette date", 'homey'),
            'reject_add_unavailable_date' => esc_html__("Ne peut pas ajouter cette indisponibilité", "homey")
		);
