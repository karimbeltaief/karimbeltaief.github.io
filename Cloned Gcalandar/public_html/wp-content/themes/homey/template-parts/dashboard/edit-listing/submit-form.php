...
<input type="hidden" name="listing_id" value="<?php echo intval( $listing_data->ID ); ?>"/>
            ...
            <div class="block">
                ...
                <div class="listing-submit-wrap">
                    ...
                    <button class="btn btn-dark-grey btn-save-listing" type="submit"><?php echo esc_attr($homey_local['update_btn']); ?></button>
                </div>
            </div>
                    ...
                    if ($layout_order) { 
                        foreach ($layout_order as $key=>$value) {
                            ...
                            switch($key) { 
                                ...
                                case 'media':
                                    ?>
                                    <li role="presentation" data-tab="media" class="<?php echo esc_attr($media_class); ?>">
