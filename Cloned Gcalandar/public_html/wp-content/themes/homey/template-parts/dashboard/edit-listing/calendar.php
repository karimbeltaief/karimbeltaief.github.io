        ...
        <div class="calendar-navigation custom-actions">
            <div class="btn-group">
                <button type="button" class="btn btn-secondary-outlined btn-reserve-period dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php echo $homey_local['sync_ical_label']; ?> <span class="caret"></span>
                </button>
                <ul class="dropdown-menu">
                    <li><a href="#" data-toggle="modal" data-target="#modal-calendar-import"><?php echo $homey_local['ical_import']; ?></a></li>
                    <li><a href="#" data-toggle="modal" data-target="#modal-calendar-export"><?php echo $homey_local['ical_export']; ?></a></li>
                </ul>
            </div>
