        ...
        <div class="row">   
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    ...
                    <select id="status" name="status" class="selectpicker" data-live-search="false" title="">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    ...
                    <input name="payout_id" type="text" class="form-control" value="<?php echo esc_attr($payout_id); ?>" placeholder="Enter the apyout ID">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    ...
                    <select id="host" name="host" class="selectpicker" data-live-search="true" title="">
                    <option value=""><?php esc_html_e('All', 'homey'); ?></option>
                    <?php
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="<?php esc_html_e('Amount', 'homey'); ?>">
                            <?php echo $price_prefix.' '.homey_formatted_price($amount); ?>
